...
import { emitExtras } from './scripts/emit-extras.mjs';
import {
...
// ---------- 6-8. RSS / 搜索索引 / 健康报告（附属产物，见 scripts/emit-extras.mjs） ----------
await emitExtras(
  { nodes, edges, graphNodes },
  { basePath: BASE_PATH, siteUrl: SITE_URL, outDir: OUT_DIR, healthIssues, toPlainText },
);
